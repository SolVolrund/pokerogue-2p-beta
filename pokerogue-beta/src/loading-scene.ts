...
export class LoadingScene extends SceneBase {
  ...
  preload() {
    ...
    this.loadImage("loading_bg", "arenas")
      ...
      .loadImage("pokeblock_kit_smaller", "items")
      .loadImage("pokeblock_red", "items")
      .loadImage("pokeblock_blue", "items")
      .loadImage("pokeblock_green", "items")
      .loadImage("pokeblock_yellow", "items")
      .loadImage("pokeblock_pink", "items")
      .loadImage("pokeblock_red_plus", "items")
      .loadImage("pokeblock_blue_plus", "items")
      .loadImage("pokeblock_green_plus", "items")
      .loadImage("pokeblock_yellow_plus", "items")
      ...
      .loadImage("fusion_summary_bg", "ui/fusiontest", "fusion_summary_bg.png", { legacy: false })
      .loadImage("fusion_summary_sprite_menu", "ui/fusiontest", "fusion_summary_sprite_menu.png", { legacy: false })
      .loadImage("fusion_summary_moves_left", "ui/fusiontest", "fusion_summary_moves_left.png", { legacy: false })
      .loadImage("fusion_summary_moves_center", "ui/fusiontest", "fusion_summary_moves_center.png", { legacy: false })
      .loadImage("fusion_summary_moves_right", "ui/fusiontest", "fusion_summary_moves_right.png", { legacy: false })
      .loadImage("fusion_summary_stats", "ui/fusiontest", "fusion_summary_stats.png", { legacy: false })
      .loadImage("fusion_summary_stats_top_flyout", "ui/fusiontest", "fusion_summary_stats_top_flyout.png", {
        legacy: false,
      })
      .loadImage("fusion_summary_stats_mid_flyout", "ui/fusiontest", "fusion_summary_stats_mid_flyout.png", {
        legacy: false,
      })
      .loadImage("fusion_summary_stats_bottom_flyout", "ui/fusiontest", "fusion_summary_stats_bottom_flyout.png", {
        legacy: false,
      })
      .loadImage("fusion_summary_status_left", "ui/fusiontest", "fusion_summary_status_left.png", { legacy: false })
      .loadImage("fusion_summary_status_mid", "ui/fusiontest", "fusion_summary_status_mid.png", { legacy: false })
      .loadImage("fusion_summary_status_right", "ui/fusiontest", "fusion_summary_status_right.png", { legacy: false })
      ...
      .loadImage("select_cursor_player_2", "ui", "select_cursor_player_2.png", { legacy: false })
      .loadImage("select_cursor_player_3", "ui", "select_cursor_player_3.png", { legacy: false })
