...
export const CFG_KEYBOARD_QWERTY: KeyboardConfig = {
  ...
  settings: {
    ...
    [SettingKeyboard.BUTTON_CYCLE_PASSIVE]: Button.CYCLE_PASSIVE,
    ...
    [SettingKeyboard.ALT_BUTTON_CYCLE_PASSIVE]: Button.CYCLE_PASSIVE,
  ...
  default: {
    ...
    KEY_O: -1,
    KEY_P: SettingKeyboard.BUTTON_CYCLE_PASSIVE,
