...
export class AttemptCapturePhase extends PokemonPhase {
  ...
  start() {
    ...
    globalScene.getPlayerPokeballCounts(this.playerIndex)[this.pokeballType]--;
    ...
    globalScene.ui.showText(
      ...
      () => {
        ...
        const addToParty = (slotIndex?: number) => {
          const newPokemon = pokemon.addToParty(this.pokeballType, slotIndex, this.playerIndex);
